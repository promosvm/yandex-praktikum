...
[Финальный проект](https://github.com/promosvm/yandex-praktikum/tree/main/project/13-финальный-проект)

</td>
<td>

Даны персональные данные о некоторых клиентах, информация об их тарифах и договорах. Каждая строчка – это данные по клиенту. Задача по параметрам определить уйдет клиент или нет.
